...
let songs = [
    ...
    },
    {
        ...
        lyrics: [
          { time: 42, text: "Through it all once again, came to know my only friend" },
            ...
            { time: 73.8, text: "I should've stayed and let you be" },
            { time: 80, text: "Run into my heart so carelessly" },
            { time: 86, text: "That's the reason I'm afraid" },
            { time: 90, text: "You're thoughts that can't be tamed" },
            { time: 93, text: "And I'm trying to be sane" },
            { time: 101, text: "And I'm trying to be sane" },
            { time: 106, text: "And I'm trying to be sane" }
        ]
    },
    {
    ...
    },
    {
        ...
        audioSrc: "audio/whereweare.mp3",
        videoBgSrc: "videos/whereweare.mp4",
        lyrics: [
            { time: 0.5, text: "Where We Are" },
            { time: 8, text: "Summer days, Rushing by you and me" },
            { time: 13, text: "Makes it harder to see underneath?" },
            { time: 16.9, text: "Did we ever know? " },
            { time: 18, text: "Did we ever know" },
            { time: 20, text: "Did we ever know?(did we ever know)" },
            { time: 24, text: "is it all inside of my head?" },
            { time: 29, text: "Maybe u still think i don't care, But all i need is YOU?" },
            { time: 36, text: "Yeah, You know it's true, Yeah you know it's true" },
            { time: 40, text: "Forget about where we are and let go" },
            { time: 46, text: "Were so close if you don't know " },
            { time: 51, text: "WHERE TO START JUST HOLD ON AND DON'T RUN" },
            { time: 59.9, text: "We're looking back, we messed around" },
            { time: 64, text: "But that was then, and this is now" },
            { time: 67, text: "All we need's Enough love to HOLD US" },
            { time: 75, text: "Where We Are" },
            { time: 80, text: "But that was then and This is Now" },
            { time: 84, text: "All we need's Enough love" },
            { time: 88.9, text: "TO HOLD US" },
            { time: 91, text: "Where We Are" }
        ]
    },
    {
        id: 11,
